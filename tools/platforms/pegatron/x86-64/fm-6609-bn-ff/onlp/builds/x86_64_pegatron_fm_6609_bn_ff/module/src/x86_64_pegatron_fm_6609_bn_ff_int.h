...
typedef enum psu_oid_e {
    ...
    PSU_OID_VRM1 = ONLP_PSU_ID_CREATE(PSU_ID_VRM1),
    PSU_OID_VRM2 = ONLP_PSU_ID_CREATE(PSU_ID_VRM2),
    PSU_OID_VRM3 = ONLP_PSU_ID_CREATE(PSU_ID_VRM3),
} psu_oid_t;
...
typedef enum thermail_id_e {
    ...
    THERMAL_ID_ON_VRM1_1,
    THERMAL_ID_ON_VRM2_1,
    THERMAL_ID_ON_VRM3_1,
    THERMAL_ID_END,
} thermail_id_t;
...
typedef enum thermail_oid_e {
    ...
    THERMAL_OID_ON_VRM1_1 = ONLP_THERMAL_ID_CREATE(THERMAL_ID_ON_VRM1_1),
    THERMAL_OID_ON_VRM2_1 = ONLP_THERMAL_ID_CREATE(THERMAL_ID_ON_VRM2_1),
    THERMAL_OID_ON_VRM3_1 = ONLP_THERMAL_ID_CREATE(THERMAL_ID_ON_VRM3_1),
} thermail_oid_t;
