...
int main()
{
	...
	do {
		...
		printf("\n 30. Read Config Space reg");
		printf("\n 31. Write Config Space reg");
		printf("\n 32. Close");
		printf("\n 33. Exit");
        ...
        switch(Opt) {
            ...
            case 30:
                ...
                fpga_read_config_reg(offset, &value);

                printf("\n Config Read Value : %d", value);
                break;
            case 31:
                printf("\n Enter the offset (in Hex): ");
                scanf("%x", &offset);
                ...
                fpga_write_config_reg(offset, value);
                break;
            case 32:
                fpga_dev_close();
                break;
