...
BDX_LED_CNTL_REG=0x0C
BDX_CONSOLE_AUTO_MASK=0x04    # CPLD register C [2]
...
BMC_ADC_OP_REG=0xDC
BMC_ADC_MONITOR_AMOUNT=16
BMC_ADC_MONITOR_LABEL=("P12V" "P5V" "P3V3_STBY" "P3V3_PCH" "P1V5_PCH" "PVCCKRHV" "PVCCSCFUSESUS" "DDR4_VPP" "P1V2_VDDQ" "PVCCIN" "P1V05" "P3V3_AUX" "P1V2_AUX" "P1V15_AUX" "P2V5_AUX" "P3V_BATT" )

## I2C related
#I2C_MUX_A=0x72
#I2C_MUX_B=0x73
I2C_BUS_NPU=0
I2C_ACTION_DELAY=0.1        ## second
...
MPC_OPERATION_REG=0x1
MPC_OPERATION_MARGIN_OFF_VAL=0x88
MPC_OPERATION_MARGIN_LOW_ACT_FAULT_VAL=0x98
MPC_OPERATION_MARGIN_HIGH_ACT_FAULT_VAL=0xA8
...
MPC_TPS40428_STEP_VREF_MARGIN_HIGH_REG=0xD5
MPC_TPS40428_STEP_VREF_MARGIN_LOW_REG=0xD6
...
## QSFP-DD(Amphenol) Module Registers
...
QSFPDD_SOFT_RESET_REG=0x1A              ## Page:0x00 ; Address:0x1A ; Bits[3]:Software Reset
QSFPDD_DETECT_INPUT_SIGNAL_REG=0xE1
QSFPDD_CONTROL_OUTPUT_SIGNAL_REG=0xFE   ## Page:0xFF ; Address:0xFE ; Bits[7-6]:ModPrsL control, Bits[5-4]:IntL control
...
LOG_PATH_CPU="$LOG_PATH_HOME/CPU"
...
ONIE_PARTITION_DIAG_NAME="PEGATRON-DIAG"
ONIE_PARTITION_LOG_NAME=$ONIE_PARTITION_DIAG_NAME    ## Due to partition 2 is still there, so ONL use that part to test
##                     ="ONL-DATA"                   ## 'LOG-DIAG' only for ONIE MFG, ONL has no this partition lable. ONL can use 'ONL-DATA' as root disk.
...
function Variable_Setting_Porsche ()
{
    ...
    I2C_BUS_MCU=$I2C_BUS_MUX_A_CHANNEL_3
    FAN_AMOUNT=5
    ...
    I2C_BUS_PMBUS=$I2C_BUS_MUX_B_CHANNEL_3
    PMBUS_MB_A_ADDR=0x60
    PMBUS_MB_B_ADDR=0x09
    ## SYSTEM and front ports LED
    I2C_BUS_SYSTEMLED=$I2C_BUS_MUX_B_CHANNEL_1
    ...
    ## EEPROM of MainBoard
    I2C_BUS_MB_EEPROM=$I2C_BUS_MUX_A_CHANNEL_2
    I2C_BUS_MB_EEPROM_WP=$I2C_BUS_MUX_B_CHANNEL_1
    CPLD_MCR2_CONTROL=$CPLD_B_ADDR
    CPLD_MCR2_REG=0x12
    CPLD_MCR2_EEPROM_WP_BIT=0x04
    ## PSU related
    I2C_BUS_PSU=$I2C_BUS_MUX_B_CHANNEL_1
...
function Variable_Setting_Bugatti ()
{
    ...
    PMBUS_MB_A_ADDR=0x60
    PMBUS_MB_B_ADDR=0x09
    I2C_BUS_VOLTAGE=$I2C_BUS_MUX_B_CHANNEL_0
    ...
    I2C_BUS_SYSTEMLED=$I2C_BUS_MUX_B_CHANNEL_0
    ...
    ## EEPROM of MainBoard
    I2C_BUS_MB_EEPROM=$I2C_BUS_MUX_A_CHANNEL_2
    I2C_BUS_MB_EEPROM_WP=$I2C_BUS_MUX_B_CHANNEL_0
    CPLD_MCR2_CONTROL=$CPLD_A_ADDR
    CPLD_MCR2_REG=$CPLD_MCR_REG
    CPLD_MCR2_EEPROM_WP_BIT=0x04
    ## PSU related
    I2C_BUS_PSU=$I2C_BUS_MUX_B_CHANNEL_0
...
function Variable_Setting_Jaguar ()
{
    ...
    PMBUS_MB_A_ADDR=0x60
    PMBUS_MB_B_ADDR=0x09
    I2C_BUS_VOLTAGE=$I2C_BUS_MUX_B_CHANNEL_1
...
function Variable_Setting_Gemini ()
{
    ...
    ## Multiphase Controller on MainBoard
    I2C_BUS_PMBUS=$I2C_BUS_MUX_A_CHANNEL_2
    ...
    ## EEPROM of MainBoard
    I2C_BUS_MB_EEPROM=$I2C_BUS_MUX_B_CHANNEL_3
    I2C_BUS_MB_EEPROM_WP=$I2C_BUS_MUX_B_CHANNEL_1
    CPLD_MCR2_CONTROL=$CPLD_B_ADDR
    CPLD_MCR2_REG=0x12
    CPLD_MCR2_EEPROM_WP_BIT=0x04
...
function Variable_Setting_Aston()
{
    ...
    ## MainBoard MCU and Fan
    I2C_BUS_MCU=$I2C_BUS_MUX_A_CHANNEL_2
    FAN_AMOUNT=6
    ...
    ## Multiphase Controller on MainBoard
    I2C_BUS_PMBUS=$I2C_BUS_MUX_A_CHANNEL_3
    ...
    ## PSU-A or PSU-B power OK  => PWR Green & Red Solid ON
    ## PSU-A and PSU-B power OK => PWR Green Solid ON
    CPLD_LEDCR1_VALUE_DEFAULT=0x84
    #CPLD_LEDCR1_VALUE_NORMAL=0x24    # SYS green on & PWR green on & LOC off
    CPLD_LEDCR1_VALUE_NORMAL=0x3C    # SYS green on & PWR AUTO     & LOC off
    ...
    CPLD_C_LEDCR1_SLED_DISABLE=0x10    # CPLD_SYS_LED blink, SLED & SFP+ LED disable
    ...
    # Module signal register.
    CPLD_B_QDDRSTR1_REG=0x48 ## QSFP-DD Reset Register (0x48~0x4B)
    CPLD_B_QDDRSTR2_REG=0x4A
    CPLD_C_QDDRSTR1_REG=0x48
    CPLD_C_QDDRSTR2_REG=0x4A
    CPLD_B_QDDINTRR1_REG=0x42  ## QSFP-DD Interrupt Status Register (0x42~0x43)
    CPLD_B_QDDINTRR2_REG=0x43
    CPLD_C_QDDINTRR1_REG=0x42
    CPLD_C_QDDINTRR2_REG=0x43
    CPLD_B_QDDIMR1_REG=0x46  ## QSFP-DD Initialization Mode Register (0x46~0x47)
    CPLD_B_QDDIMR2_REG=0x47
    CPLD_C_QDDIMR1_REG=0x46
    CPLD_C_QDDIMR2_REG=0x47
    CPLD_C_SFPPLUS_TX_EN_REG=0x4D
    CPLD_C_SFPPLUS_TX_FAULT_REG=0x4C
    CPLD_C_SFPPLUS_RX_FAULT_REG=0x4F
}

function Variable_Setting_FHGW ()
{
    SFP_PORTS_AMOUNT=9     # 6 + 2 + 1
    QSFP_PORTS_AMOUNT=1
    ...
    FAN_AMOUNT=3
    MB_MCU_ADC_MONITOR_AMOUNT=6
    ADC_MONITOR_LABEL=("P0.1 (12V)" "P0.2 (3.3V)" "P0.6 (1.8V)" "P0.7 (1.0V_CORE)" "P1.2 (3.3V_STB)" "P1.6 (1.0V)")
    ## Multiphase Controller on MainBoard
    I2C_BUS_PMBUS=$I2C_BUS_MUX_A_CHANNEL_2
    PMBUS_MB_A_ADDR=0x60    ## TP53679
    I2C_BUS_VOLTAGE=$I2C_BUS_MUX_B_CHANNEL_1
    ...
    I2C_BUS_SYSTEMLED=$I2C_BUS_MUX_B_CHANNEL_1
    CPLD_LED_CONTROL=$CPLD_B_ADDR
    CPLD_LEDCR1_REG=0x09
    CPLD_LEDCR2_REG=0x0A
    CPLD_LEDCR1_VALUE_GREEN=0x11     # SYS green on & FAN green on
    CPLD_LEDCR1_VALUE_DEFAULT=${CPLD_LEDCR1_VALUE_GREEN}
    CPLD_LEDCR1_VALUE_NORMAL=${CPLD_LEDCR1_VALUE_GREEN}
    CPLD_LEDCR1_VALUE_AMBER=0x22     # SYS amber on & FAN amber on
    CPLD_LEDCR1_VALUE_RED=0x55       # SYS red on & FAN red on
    CPLD_LEDCR1_VALUE_OFF=0x00       # SYS off      & FAN off
    CPLD_LEDCR1_VALUE_SYSTEM_ERROR_BLINK=0x40
    CPLD_LEDCR1_VALUE_GREEN_BLINK=0x33                             # SYS green blink & FAN green blink
    CPLD_LEDCR1_VALUE_AMBER_BLINK=0x44                             # SYS amber blink & FAN amber blink
    CPLD_LEDCR2_VALUE_GREEN=0x01     # LOC off & PWR green on
    CPLD_LEDCR2_VALUE_NORMAL=${CPLD_LEDCR2_VALUE_GREEN}
    CPLD_LEDCR2_VALUE_AMBER=0x02     # LOC off & PWR amber on
    CPLD_LEDCR2_VALUE_OFF=0x00       # LOC off & PWR off
    CPLD_LEDCR2_VALUE_BLUE=0x10      # LOC on  & PWR off
    CPLD_LEDCR2_VALUE_GREEN_BLINK=0x03                             # LOC off & PWR green blink
    CPLD_LEDCR2_VALUE_AMBER_BLINK=0x04                             # LOC off & PWR amber blink
    CPLD_MCR_REG=0x1
    CPLD_MCR_VALUE_NORMAL=0x00       # ports LED normal
    CPLD_MCR_VALUE_GREEN=0x10        # ports green and blue on
    CPLD_MCR_VALUE_AMBER=0x20
    CPLD_MCR_VALUE_OFF=0x30
    ## EEPROM of MainBoard
    I2C_BUS_MB_EEPROM=$I2C_BUS_MUX_B_CHANNEL_3
    I2C_BUS_MB_EEPROM_WP=$I2C_BUS_MUX_B_CHANNEL_1
    I2C_BUS_CPLD=$I2C_BUS_MUX_B_CHANNEL_1
    CPLD_MCR2_CONTROL=$CPLD_B_ADDR
    CPLD_MCR2_REG=0x14
    CPLD_MCR2_EEPROM_WP_BIT=0x02
    CPLD_MCR2_UART_SEL_BIT=0x20
    ## PSU related
    I2C_BUS_PSU=$I2C_BUS_MUX_B_CHANNEL_1
    CPLD_PSR_CONTROL=$CPLD_B_ADDR
    CPLD_PSR_REG=0x11
...
function Project_ID_Check ()
{
    ...
    case $board_ID_bit in
        ...
        1001)   PROJECT_NAME="GEMINI"
                ...
                ;;
        1010)   PROJECT_NAME="FHGW"
                Variable_Setting_FHGW
                ;;
        1111)   ## if strap pin are full, will decide by CPLD register (0xFE [6:0])
                data_result=$( { i2cget -y $I2C_BUS_MUX_B_CHANNEL_0 $CPLD_A_ADDR 0xFE ; } 2>&1 )
...
function I2C_BUS_TREE ()
{
    if [[ "$SUPPORT_CPU" == "BDXDE" ]]; then
        I2C_BUS_ARBITER_AND_AFTER=1
        I2C_BUS_MUX_A_CHANNEL_0=2
        I2C_BUS_MUX_A_CHANNEL_1=3
        I2C_BUS_MUX_A_CHANNEL_2=4
        I2C_BUS_MUX_A_CHANNEL_3=5
        I2C_BUS_MUX_B_CHANNEL_0=6
        I2C_BUS_MUX_B_CHANNEL_1=7
        I2C_BUS_MUX_B_CHANNEL_2=8
        I2C_BUS_MUX_B_CHANNEL_3=9
        I2C_BUS_MUX_B_CHANNEL_4=10
        I2C_BUS_MUX_B_CHANNEL_5=11
        I2C_BUS_MUX_B_CHANNEL_6=12
        I2C_BUS_MUX_B_CHANNEL_7=13
    else
        I2C_BUS_ARBITER_AND_AFTER=$I2C_BUS_NPU
        I2C_BUS_MUX_A_CHANNEL_0=1
        I2C_BUS_MUX_A_CHANNEL_1=2
        I2C_BUS_MUX_A_CHANNEL_2=3
        I2C_BUS_MUX_A_CHANNEL_3=4
        I2C_BUS_MUX_B_CHANNEL_0=5
        I2C_BUS_MUX_B_CHANNEL_1=6
        I2C_BUS_MUX_B_CHANNEL_2=7
        I2C_BUS_MUX_B_CHANNEL_3=8
        I2C_BUS_MUX_B_CHANNEL_4=9
        I2C_BUS_MUX_B_CHANNEL_5=10
        I2C_BUS_MUX_B_CHANNEL_6=11
        I2C_BUS_MUX_B_CHANNEL_7=12
    fi

    I2C_BUS_PSU_A=$I2C_BUS_MUX_A_CHANNEL_0
    I2C_BUS_PSU_B=$I2C_BUS_MUX_A_CHANNEL_1
}
...
function Log_Folder_Check ()
{
    ...
    if (( 1 )); then     ## ONL seems no need additional disk to store logs, the root (sda7) is 23G available.
        ## Mount to disk.
    ...
    if [ ! -d "$LOG_PATH_CPU" ]; then mkdir "$LOG_PATH_CPU"; fi
}
...
#
#        cp -f ${HOME}/mfg/i2c-tools/i2c_arbiter/* /usr/sbin/
#        sync
#    fi
#fi
...
if [[ ! -L "$MFG_WORK_DIR/sdk_start" ]]; then
    if [[ "$PROJECT_NAME" == "GEMINI" ]]; then
        ln -s ${MFG_WORK_DIR}/platform_sdk_start/gemini_sdk_start.sh $MFG_WORK_DIR/sdk_start
    elif [[ "$PROJECT_NAME" == "ASTON" ]]; then
        ln -s ${MFG_WORK_DIR}/platform_sdk_start/aston_sdk_start.sh $MFG_WORK_DIR/sdk_start
    elif [[ "$PROJECT_NAME" == "PORSCHE" ]]; then
        ln -s ${MFG_WORK_DIR}/platform_sdk_start/porsche2_sdk_start.sh $MFG_WORK_DIR/sdk_start
    elif [[ "$PROJECT_NAME" == "FHGW" ]]; then
        ln -s ${MFG_WORK_DIR}/platform_sdk_start/fhgw_sdk_start.sh $MFG_WORK_DIR/sdk_start
    else
...
if [[ "$SUPPORT_CPU" == "BDXDE" ]]; then
    ...
    #    insmod $MFG_WORK_DIR/tools/intel_nvm_flash_update_tool/iqvlinux.ko
    #fi
    #if [[ ! -L "/lib64" ]]; then
    #    ln -s /lib /lib64
    #fi
